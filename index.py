    ...
    try:
        ...
        if status == 2:
            ...
            <body style="text-align: center;">
                ...
                <p>Please click <a href="{URL}">here</a> (alternatively directly paste following link: {URL}) to verify your account and to generate services for you. This link will expire on {expires_at}.</p>
                <p>Thank you,</p>
            </body>
            </html>
            """
